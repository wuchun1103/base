<template>
  <div class="personal-panel">
    <div class="personal-desc" :style="{'background':this.$store.state.app.themeColor}">
        ...
        <div class="name-role">
          <span class="sender">{{user.userCode}}-{{ user.userName }} </span>
        </div>
        <div class="registe-info">
          <span class="registe-info">
            <li class="fa fa-clock-o"></li>
            登录时间：{{ user.registeInfo }}
          </span>
        </div>
    </div>
    ...
    <div class="main-operation">
        <span class="main-operation-item">
          ...
          <el-button size="small" icon="fa fa-male"
                    ref="userInfoDialog" @click="personinfo"> 个人中心</el-button>
        </span>
        <span class="main-operation-item">
          <el-button size="small" icon="fa fa-key" @click="modpass"> 修改密码</el-button>
        </span>
    </div>
    ...
    <user-info ref="userInfoDialog"></user-info>
    <pass-update ref="passUpdateDialog"></pass-update>
  </div>
...
import PassUpdate from "@/views/Sys/PassUpdate"
...
export default {
  ...
  methods: {
    ...
    // },
    personinfo : function() {
      this.$refs.userInfoDialog.setBackupVisible(true,this.user.userCode)
      // this.$router.push("/sys/userInfo")
    },
    modpass : function() {
      this.$refs.passUpdateDialog.setPassVisible(true)
