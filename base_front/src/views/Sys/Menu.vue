      ...
      >
        <el-form-item label="菜单类型" prop="menuType">
          <el-radio-group v-model="dataForm.menuType">
            <el-radio v-for="(menuType, index) in menuTypeList" :label="index" :key="index">{{ menuType }}</el-radio>
          </el-radio-group>
        </el-form-item>
        <el-form-item :label="menuTypeList[dataForm.menuType] + '名称'" prop="name">
          <el-input v-model="dataForm.name" :placeholder="menuTypeList[dataForm.menuType] + '名称'"></el-input>
        </el-form-item>
        ...
        <el-form-item v-if="dataForm.menuType === 1" label="菜单路由" prop="url">
          <el-row>
            <el-col :span="22">
